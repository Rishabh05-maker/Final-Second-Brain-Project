...
const AddCategoryFormWrapper = () => {
  ...
  return (
      <div className="flex flex-col justify-center items-start mt-6 space-y-6">
        ...
        <button
          onClick={toggleForm}
          className="text-white border rounded-full bg-pink-400 w-[60px] h-[60px] text-2xl flex items-center justify-center mb-4"
        >
          +
        </button>
          ...
          {formikProp => (
            <Form>
              <AddCategoryForm 
                ...
                buttonName={"Add category"} // Ensure buttonName is passed correctly
              />
            </Form>
          )}
        </Formik>
